...
const WhatsAppFAB = () => {
  const phone = gym.location.phone.replace(/\D/g, '');
  const msg = encodeURIComponent('Hi 369 Fitness Wellness! I would like to book a free trial.');
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 w-16 h-16 flex items-center justify-center shadow-xl hover:scale-110 transition-transform"
    >
